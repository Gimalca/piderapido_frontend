 <header class="navbar navbar-fixed-top bg-light">
            <div class="navbar-branding">
                <a class="navbar-brand" href="home.php"> <b>Pide Rápido </b> KFC
                </a>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-persist pn w250 bg-white" role="menu">
                        ...
                        <li class="br-t of-h">
                            <a href="ajustes.php" class="fw600 p12 animated animated-short fadeInDown">
                                <span class="fa fa-gear pr5"></span> Ajustes de cuenta </a>
                        </li>
                        <li class="br-t of-h">
                            <a href="index.php" class="fw600 p12 animated animated-short fadeInDown">

        ...
        <section id="content_wrapper">
            ...
            <section id="content" class="animated fadeIn">
				...
				<h2 class="lh30 mt15 text-center">
					Pedidos
					<b class="text-primary">Solicitados</b>
				</h2>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="section-divider mt40 mb25" id="spy4">
                                                <span>Pedidos Solicitados - Fecha</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-danger notification" data-dismiss="modal" data-note-style="success" type="submit">Procesar Pedido</button>
                                            </td>
                                        </tr>
                                        <tr>

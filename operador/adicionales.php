        ...
        <section id="content_wrapper">      
            ...
            <section id="content" class="animated fadeIn">
                <h2 class="lh30 mt15 text-center">
                    Disponibilidad 
                    <b class="text-primary">Adicionales</b>
                </h2>                 
                </br>                   
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <span class="glyphicons glyphicons-fast_food"></span>Adicionales</span>
                        </div>
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th><b><center>Cambio de precio</center></b></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td><button type="button" class="btn btn-light" data-toggle="modal" data-target="#exampleModal" data-whatever="Pepsi - Pequeña">Precio</button></td>                                        
                                    </tr>
                                    <tr>
                                        <td>Pepsi - Mediana</td>
                                        <td>
                                        ...
                                        <td><button type="button" class="btn btn-light" data-toggle="modal" data-target="#exampleModal" data-whatever="Pepsi - Mediana">Precio</button></td> 
                                    </tr>
                                    <tr>
                                        <td>Pepsi - Grande</td>
                                        <td>
                                        ...
                                        <td><button type="button" class="btn btn-light" data-toggle="modal" data-target="#exampleModal" data-whatever="Pepsi - Grande">Precio</button></td> 
                                    </tr>
                                    <tr>
                                        <td>Helado</td>
                                        <td>
                                            <label class="switch block mt15">
                                                <div class="switch switch-success round switch-inline">
                                                    ...
                                                    <label for="exampleCheckboxSwitch4" data-on="SI" data-off="NO"></label>
                                                </div>
                                            </label>
                                        </td>                                        
                                        <td><button type="button" class="btn btn-light" data-toggle="modal" data-target="#exampleModal" data-whatever="Helado">Precio</button></td> 
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                  ...
                  <div class="modal-body">
                    <form>
                      <div class="form-group">
                        <label for="tamaño-combo" class="control-label">Precio nuevo: </label>
                        <input type="text" class="form-control" id="tamaño-combo" value="100Bs">
                      </div>                      
                    </form>
                  </div>

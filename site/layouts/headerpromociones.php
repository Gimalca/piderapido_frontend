  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <p class="text-center"> ¿No tienes cuenta? <a data-toggle="modal" data-dismiss="modal" href="#ModalSignup"> Regístrate. </a> <br>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-sm-6 col-xs-6 col-md-6 no-margin no-padding">
          ...
          <li style="margin-right: 25px;"><a class="fa fa-youtube tooltipHere" href="https://www.youtube.com/channel/UCaW4eyI65cTrLTWWRRIlZjQ" data-original-title="youtube" data-toggle="tooltip" data-placement="bottom" title=""></a></li>
			  ...
			  <li> <a href="micuenta.php"><span class="hidden-xs"> Mi cuenta</span> <i class="glyphicon glyphicon-user hide visible-xs "></i></a> </li>
              ...
              <li class="hidden-xs"> <a href="#" data-toggle="modal" data-target="#ModalSignup"> Regístrate </a> </li>
			</ul>
          </div>
        </div>
      </div>
    ...
    <div class="navbar-cart  collapse">
      <div class="cartMenu  col-lg-4 col-xs-12 col-md-4 ">
        ...
        <div class="miniCartFooter  miniCartFooterInMobile text-right">
          ...
          <a class="btn btn-sm btn-danger"> <i class="fa fa-shopping-cart"> </i> Ver Carrito </a> 
		</div>
        <!--/.miniCartFooter--> 
          ...
          <ul class="dropdown-menu">
            <li class="megamenu-content"> 
              ...
              <ul class="col-lg-6 col-sm-2 col-md-6  unstyled noMarginLeft">
				...
				<li> 
					<br>
					<!--input id="textinput" name="textinput" placeholder="Tipo de comida" class="form-control input-md" type="text"-->
            ...
            <div class="w100 miniCartTable scroll-pane">
              <table>
                <tbody>
                  ...
                  <tr class="miniCartProduct">
                    <td style="width:20%" class="miniCartProductThumb"><div> <a href="detalleproducto.php"> <img src="images/product/combo2.jpg" alt="img"> </a> </div></td>
                    <td style="width:40%"><div class="miniCartDescription">
                  ...
                  <tr class="miniCartProduct">
                    <td style="width:20%" class="miniCartProductThumb"><div> <a hrefdetalleproducto.php <img src="images/product/combo5.jpg" alt="img"> </a> </div></td>
                    <td style="width:40%"><div class="miniCartDescription">

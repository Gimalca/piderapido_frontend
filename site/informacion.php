				  ...
				  <div class="row userInfo">
					...
					<form>
						  ...
						  <div class="row">
							...
							<div class="col-xs-4">
							  <select class="form-control" name="months" id="months">
								...
								<option selected="selected" value="12">Diciembre&nbsp;
							  </select>
							</div>
							<div class="col-xs-4">
							  <select class="form-control" name="years" id="years">
								...
								<option selected="selected" value="1998">1998&nbsp;&nbsp;
					  ...
					  <div class="col-xs-12 col-sm-6">
						...
						<div class="form-group required">
						  <label for="InputPasswordnew"> Nuevo Password </label>
						  <input type="password" name="InputPasswordnew" class="form-control" id="InputPasswordnew">
						</div>
						<div class="form-group required">
						  <label for="InputPasswordnewConfirm"> Confirmar Password </label>

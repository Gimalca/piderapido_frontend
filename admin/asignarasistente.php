       ...
       <?php include 'layout/menu.php'; ?>
        ...
        <section id="content_wrapper">
            ...
            <section id="content" class="animated fadeIn">
                ...
                <h2 class="lh30 mt15 text-center"> Asignar <b class="text-primary"> Asistentes </b></h2>
                <br>
                ...
                <div class="panel">
                                ...
                                <div class="panel-body bg-light">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 text-center">
                                            <button type="button"class="btn btn-primary notification" data-note-style="success" type="submit">Asignar Asistente</button>
                 ...
                 <h2 class="lh30 mt15 text-center"> Listado de <b class="text-primary"> Asistentes asignados </b></h2>
                 <br>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group text-center">
                                                    <center>
                                                        ...
                                                        <button class="btn btn-primary notification3" data-note-style="success" type="button">
...
$('.notification3').click(function(e) {
                var noteStyle = $(this).data('note-style');
                var noteShadow = $(this).data('note-shadow');
                var noteOpacity = $(this).data('note-opacity');
                var noteStack = $(this).data('note-stack');

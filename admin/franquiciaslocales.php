       ...
       <?php include 'layout/menu.php'; ?>
        ...
        <section id="content_wrapper">
            ...
            <section id="content" class="animated fadeIn">
                ...
                <h2 class="lh30 mt15 text-center"> Locales <b class="text-primary">por Franquicias </b></h2>
                <br>
                ...
                <div class="panel">
                    ...
                    <div class="row">
                             ...
                             <div class="row">
                                ...
                                <div class="row">
                                    <h2 class="lh30 mt15 text-center"> Listado <b class="text-primary">de Locales </b></h2>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="panel">
                                <div class="panel-heading">
                                    ...
                                    <span class="glyphicons glyphicons-fast_food"></span>Franquicia</span>
                                </div>
                                    <div class="panel-body">
                                        ...
                                        <div class="tab-content br-n pn">
                                            <div id="tab17_1" class="tab-pane active">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <img src="assets/img/logos/kfclogo.png" class="img-responsive thumbnail mr25">
                                                    </div>
                                                    <div class="col-md-8">
                                                        <h5 class="text-center"><a href="verlocales.php">Franquicia Nombre</a></h5><br>
                                                    </div>
                                                </div>
                                            </div>                                    
                                        </div>

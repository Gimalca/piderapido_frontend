    ...
    <div id="main">
        ...
        <section id="content_wrapper">
            ...
            <section id="content" class="animated fadeIn">
                 ...
                 <h2 class="lh30 mtn text-center"><b class="text-primary">Locales</b> de las Franquicias</h2><br>
			...
			<div class="panel">
                    ...
                    <div class="admin-form theme-primary">
                        ...
                        <h2 class="lh30 mtn text-center">
                            <b class="text-primary">Listado</b> de Sucursales
                        </h2>
                           ...
                           <div class="col-md-6">
                            <div class="panel">
                                <div class="panel-heading">
                                    ...
                                    <span class="glyphicons glyphicons-fast_food"></span>Sucursal</span>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="tab-content br-n pn">
                                        <div id="tab17_1" class="tab-pane active">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="assets/img/logos/kfc-sucursal.JPG" class="img-responsive thumbnail mr25">
                                                </div>
                                                <div class="col-md-8">
                                                    <h5>Sede</h5>
                                                    <p>Descripcion</p>
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li>
                                                            <a href="editar-locales.php">Editar</a>
                                                        </li>
                                                        <li>
                                                            <a href="crear-locales.php">Eliminar</a>
                                                        </li>
                                                        <li class="divider"></li>
                                                        <li class="active">
                                                            <a href="#">Activo</a>
                                    ...
                                    <div id="tab17_1" class="tab-pane active">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>
                                                        <a href="crear-locales.php">Editar</a>
                                                    </li>
                                                    <li class="divider"></li>
                                                    <li class="active">
                                                        <a href="#">Activo</a>

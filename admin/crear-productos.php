                    ...
                    <div class="col-md-4">
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <span class="glyphicons glyphicons-fast_food"></span>Crear Combo</span>
                            </div>
                                        ...
                                        <div id="tab17_1" class="tab-pane active">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 text-center">
                                                    ...
                                                    <a href="crear-combo.php" class="holder-style p15" data-steps-style="steps-tabs">
                    ...
                    <div class="col-md-4">
                                    ...
                                    <div class="tab-content br-n pn">
                                        <div id="tab17_1" class="tab-pane active">
                                            <div class="row">
                                                    ...
                                                    <div class="col-md-12 text-center">
                                                        <a href="crear-productos-individuales.php" class="holder-style p15" data-steps-style="steps-tabs">
                                                        <span class="fa fa-plus holder-icon"></span>
                                                        <br> Crear producto
                                                    </a>
                                                         <div class="btn-group text-right">
                     ...
                     <div class="col-md-4">
                        <div class="panel">
                            <div class="panel-heading">
                                <span class="panel-title">
                                <span class="glyphicons glyphicons-fast_food"></span>Crear Ingredientes Extras</span>
                            </div>
                                <div class="panel-body">
                                    <div class="clearfix"></div>
                                    <div class="tab-content br-n pn">
                                        <div id="tab17_1" class="tab-pane active">
                                            <div class="row">
                                                    ...
                                                    <div class="col-md-12 text-center">
                                                        <a href="crear-ingredientes.php" class="holder-style p15" data-steps-style="steps-tabs">
                                                        <span class="fa fa-plus holder-icon"></span>
                                                        <br> Crear ingrediente
                                                    </a>
                                                         <div class="btn-group text-right">
                                                    </div>   
                                               </div>

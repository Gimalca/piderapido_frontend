    ...
    <div id="main">
        ...
        <section id="content_wrapper">
            ...
            <section id="content" class=" pnanimated fadeIn">
                   ...
                   <h2 class="lh30 mt15 text-center"> Crear <b class="text-primary"> Franquicia </b></h2>
                ...
                <div class="admin-panels fade-onload sb-l-o-full">
                    ...
                    <!--div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title">Creación de Contraseña</span>
                        </div>
                        <div class="panel-body bg-light dark">
                            <div class="admin-form ">                                        
                                <div class="section row mb10">
                                    <label for="account-name" class="field-label col-md-3 text-center">Ingresar Contraseña: </label>
                                    <div class="col-md-9">
                                        <label for="account-name" class="field prepend-icon">
                                ...
                                <div class="section row mb10">
                                    <label for="account-name" class="field-label col-md-3 text-center">Repita la Contraseña: </label>
                                    <div class="col-md-9">
                                        <label for="account-name" class="field prepend-icon">

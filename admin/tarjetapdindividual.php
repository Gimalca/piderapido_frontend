    ...
    <div id="main">
        ...
        <section id="content_wrapper">
            ...
            <section id="content" class="animated fadeIn">
                <h2 class="lh30 mtn text-center">Tarjeta PideRapido de <b class="text-primary">Dave Robert</b></h2>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group text-center">
                                                <button type="button" class="btn btn-success br2 btn-xs fs12 dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> Aceptar
                                                    <span class="caret ml5"></span>
                                                </button>
                                                <ul class="dropdown-menu" role="menu">
                                                    <li class="active">
                                                        <a href="#" data-toggle="modal" data-target="#myModal">Aceptar</a>
                                                    </li>
                                                    <li>
                                                        <a href="#">Declinar</a>
                                                    </li>
